...
* Every phrase included in keywords MUST also appear wrapped with <strong> tags inside summarizedBodyTextHTML
* Do NOT include any keyword unless it is wrapped with <strong> tags in the HTML summary
...
* Every keywords.phrase must exactly match a phrase wrapped in <strong> tags inside summarizedBodyTextHTML
* Do not output keywords that are not highlighted in the HTML summary
* Do not wrap unnecessary words with <strong> tags
* Keep <strong> tags short and focused on meaningful learning expressions
* Avoid duplicate keywords
* Preserve natural English readability even after adding <strong> tags
